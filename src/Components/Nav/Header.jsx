    ...
    <header className="w-full min-h-[80vh] flex flex-col justify-center items-center px-4 py-20 overflow-hidden">
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center">
        <div className="flex items-center gap-2 mb-8 animate-pulse">
          ...
          <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-gray-400">Available for projects</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between w-full max-w-[90%] md:max-w-[80%] mt-4 gap-4 md:gap-0">
          ...
          <a href="https://tekuvo.com.ng" target="_blank" rel="noopener noreferrer" className="text-[10px] md:text-xs font-mono uppercase tracking-[0.3em] text-gray-500 text-center md:text-right">
            Founder of Tekuvo
          </a>
        </div>
        ...
        <nav className="flex flex-wrap justify-center gap-3 md:gap-6 mt-16 md:mt-24">
          ...
          <a href="#works" className="nav-pill">Works</a>
          <a href="#fun" className="nav-pill">Fun</a>
