...
const Awards = () => {
  const awards = [
    { name: "Awwwards (SOTD)", project: "Genpay", year: "2025" },
    { name: "FWA (SOTD)", project: "X-republik", year: "2024" },
    { name: "Awwwards (SOTD)", project: "QuickShip", year: "2024" },
    { name: "CSSDA (WOTD)", project: "Tekuvo", year: "2023" },
  ];
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-gray-500">Recognition</span>
          </div>
          <h3 className="text-3xl md:text-5xl font-display uppercase leading-[0.9] tracking-tight text-white">
            Awards & <br />
            <span className="text-gray-500 italic">Honors</span>
          </h3>
        </div>
          ...
          {awards.map((award, index) => (
            <div key={index} className="group grid grid-cols-1 md:grid-cols-3 py-10 border-b border-white/10 gap-6 md:gap-12 items-center transition-all duration-500 hover:px-4">
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-mono text-gray-600 uppercase tracking-widest">{award.year}</span>
