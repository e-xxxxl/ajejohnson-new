...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      className="w-full bg-black pt-32 pb-12 px-4 border-t border-white/5 overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 mb-32">
          <div className="flex flex-col gap-8 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <a
                href="mailto:eajejohnson@gmail.com"
                className="nav-pill px-8 py-4 bg-white text-black border-white"
              >
                eajejohnson@gmail.com
              </a>
              <button
                onClick={() => {
                  navigator.clipboard.writeText("eajejohnson@gmail.com");
                  setCopied(true);

                  setTimeout(() => setCopied(false), 2000);
                }}
                className="nav-pill px-8 py-4 transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-2 gap-12 md:gap-24">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <a
                  href="https://www.instagram.com/emmy_gram._/"
                  className="text-sm uppercase tracking-wider hover:text-gray-400 transition-colors"
                >
                  Instagram
                </a>
                <a
